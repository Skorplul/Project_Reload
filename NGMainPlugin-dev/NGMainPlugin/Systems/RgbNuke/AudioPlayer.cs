...
public static class AudioPlayer
{
    ...
    private static string AudioPath => Main.Singleton.Config.MusicDirectory
        .Replace("{global}", Paths.GlobalPlugins.Plugins);

    private static int Volume => Main.Singleton.Config.Volume;
    ...
    private static void AddDummy()
    {
        ...
        try
        {
            _audioBot.nicknameSync.SetNick(Main.Singleton.Config.DisplayName);
        }
        catch (Exception)
        {
        }
